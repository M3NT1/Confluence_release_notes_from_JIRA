...
import time
import re
from tkinter import ttk  # macOS-specifikus elemekhez
...
class GUIApp:
    def __init__(self, root, config_manager):
        ...
        self.root.geometry("800x600")  # macOS-hoz optimalizált méret
        ...
        self.url_label = ttk.Label(url_frame, text="JIRA keresési URL:")
        ...
        self.version_label = ttk.Label(version_frame, text="Verziószám:")
        ...
        self.date_label = ttk.Label(date_frame, text="Telepítés dátuma (YYYYMMDD):")
        ...
        self.submit_button = ttk.Button(button_frame, text="Generálás és mentés", command=self.run_thread)
        self.submit_button.pack(side=tk.LEFT, padx=5)

        pat_button = ttk.Button(button_frame, text="JIRA PAT Token módosítása", command=self.update_pat_token)
        pat_button.pack(side=tk.LEFT, padx=5)

        exit_button = ttk.Button(button_frame, text="Kilépés", command=root.destroy)
